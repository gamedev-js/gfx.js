  ...
  link() {
    ...
    if (!gl.getShaderParameter(vertShader, gl.COMPILE_STATUS)) {
      ...
      vertexShaderErrors.forEach(error => {
        errors.push(error);
        console.error(`Failed to compile vertex shader:: file ${error.file}, line ${error.line}, message: ${error.message}`);
      });
      failed = true;
    }
    ...
    if (!gl.getShaderParameter(fragShader, gl.COMPILE_STATUS)) {
      ...
      fragmentShaderErrors.forEach(error => {
        errors.push(error);
        console.error(`Failed to compile fragment shader:: file ${error.file}, line ${error.line}, message: ${error.message}`);
      });
      failed = true;
    }
