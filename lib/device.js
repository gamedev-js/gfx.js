...
function _commitStencilStates(gl, cur, next) {
  ...
  if (next.stencilSep) {
    if (cur.stencilFuncFront !== next.stencilFuncFront || cur.stencilRefFront !== next.stencilRefFront ||
    ...
    if (cur.stencilFailOpFront !== next.stencilFailOpFront || cur.stencilzFailOpFront !== next.stencilzFailOpFront ||
      cur.stencilzPassOpFront !== next.stencilzPassOpFront) {
      gl.stencilOpSeparate(gl.FRONT, next.stencilFailOpFront, next.stencilzFailOpFront, next.stencilzPassOpFront);
    }
    if (cur.stencilFuncBack !== next.stencilFuncBack || cur.stencilRefBack !== next.stencilRefBack ||
    ...
    if (cur.stencilFailOpBack !== next.stencilFailOpBack || cur.stencilzFailOpBack !== next.stencilzFailOpBack ||
